...
class Calculator:
    def __init__(self, master):
        ...
        # Create a StringVar object to track the equation being entered
        self.equation = StringVar()
        self.entry_value = ''
        # Calculator Number Window
    ...
    # Concatenates the input value to the entry_value string and updates the equation
    def show(self, value):
        self.entry_value += str(value)
        self.equation.set(self.entry_value)

    # Clears the entry_value
    def clear(self):
        self.entry_value = ''
        self.equation.set(self.entry_value)

    # Solves the expression in entry_value
    def solve(self):
